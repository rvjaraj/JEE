...
a persistence unit "testejbPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "testejb\pom.xml":
...
artifact ("testejb.war") is already built. You can build
